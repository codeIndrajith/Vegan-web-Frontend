              ...
              <div className='p-4 h-auto overflow-y-auto'>
                <form className='grid gap-4 py-8 px-2' onSubmit={submitHandler}>
                  <div className='grid grid-cols-1 lg:grid-cols-3 gap-2 lg:gap-1 items-center'>
                    ...
                    <input required name='image' value={formData.image} onChange={handleChnage} className='border pl-4 col-span-2 py-1 lg:py-2 rounded-sm w-full' type="text" />
                  </div>

                  <div className='grid grid-cols-1 lg:grid-cols-3 gap-2 lg:gap-1 items-center'>
                    <label className='text-sm lg:text-lg col-span-1'>Product Name</label>
                    <input required name='productName' value={formData.productName} onChange={handleChnage} className='border pl-4 col-span-2 py-1 lg:py-2 rounded-sm w-full' type="text" />
                  </div>

                  <div className='grid grid-cols-1 lg:grid-cols-3 gap-2 lg:gap-1 items-center'>
                    <label className='text-sm lg:text-lg col-span-1'>Product Price</label>
                    <input required name='productPrice' value={formData.productPrice} onChange={handleChnage} className='border pl-4 col-span-2 py-1 lg:py-2 rounded-sm w-full' type="number" />
                  </div>

                  <div className='grid grid-cols-1 lg:grid-cols-3 gap-2 lg:gap-1 items-center'>
                    <label className='text-sm lg:text-lg col-span-1'>Description</label>
                    <input required name='description' value={formData.description} onChange={handleChnage} className='border pl-4 col-span-2 py-1 lg:py-2 rounded-sm w-full' type="text" />
                  </div>

                  <div className='grid grid-cols-1 lg:grid-cols-3 gap-2 lg:gap-1 items-center'>
                    <label className='text-sm lg:text-lg col-span-1'>Product Includes</label>
                    <input required name='productIncludes' value={formData.productIncludes} onChange={handleChnage} className='border pl-4 col-span-2 py-1 lg:py-2 rounded-sm w-full' type="text" />
                  </div>
